...
import github.zhangman.espressouitest.fragmentisolation.data.source.MoviesRemoteDataSource
import kotlinx.android.synthetic.main.fragment_movie_detail.*

/**
 * Created by admin on 2021/2/25 14:33.
...
class MovieDetailFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.getInt("movie_id").let { movieId ->
            movieId?.let {
                MoviesRemoteDataSource.getMovie(it)?.let { movieFromRemote ->
